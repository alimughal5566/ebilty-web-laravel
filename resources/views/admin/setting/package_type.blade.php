...
@section('content')
                                ...
                                <table class="table" id="payment_type_table">
                                    ...
                                    @forelse($types as $type)
                                        <tr>
                                            ...
                                            <td>
                                                <a onclick="edit_package_type({{$type->id}})" class="btn btn-primary btn-sm"> <i class="fas fa-edit"></i>  </a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Package Type</h5>
                                    ...
                                    <div class="kt-section__body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <input class="form-control" type="text" id="name" name="name" placeholder="Enter package type" required="">
    ...
    <div class="modal fade" id="edit_package_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <script>
        $('#add_payment_form').on('submit', function(e) {
            e.preventDefault();
            var url = '{{route('admin.setting.add_package_type')}}';
        ...
        function make_status_active(id){
            $(this).parents('tr').first().remove();
            var url = '{{route('admin.setting.make_status_active_package_type')}}'
            $.ajax({
                type: "get",
                url: url,
                data: {id:id},
        ...
        function make_status_inactive(id){
            $(this).parents('tr').first().remove();
            var url = '{{route('admin.setting.make_status_inactive_package_type')}}'
            $.ajax({
                type: "get",
                url: url,
                data: {id:id},
